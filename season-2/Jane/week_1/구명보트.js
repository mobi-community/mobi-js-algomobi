...
2. 가장 가벼운 사람의 인덱스가 가장 무거운 사람의 인덱스보다 커지지 않을 때까지 반복한다.
3. 만약 people[heaviest]와 people[lightest]의 합이 limit보다 작다면 가장 가벼운 사람의 인덱스를 하나 증가시킨다.
4. 가장 무거운 사람의 인덱스는 모든 경우에 하나씩 감소한다.
